...
describe('static texture keys', () => {
  ...
  it('covers every key whose art has landed', () => {
    ...
    // is the ring ground areas are drawn with, the outline over a spell's own
    // clip (`AREA_LOOKS`, #179), the whole look for one without and what Ice
    // Storm falls back to without the atlas (#219).
